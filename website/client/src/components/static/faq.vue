...
export default {
  ...
  data () {
    ...
    return {
      ...
      // },
      // "webFaqStillNeedHelp": "If you have a question that isn't on this list or on the [Wiki FAQ](https://slay.fandom.com/wiki/FAQ), come ask in the <%= linkStart %>Slay Help guild<%= linkEnd %>! We're happy to help."
    };
  },
  mounted () {
