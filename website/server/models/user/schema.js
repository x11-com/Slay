...
const RESTRICTED_EMAIL_DOMAINS = Object.freeze(['slay.com', 'donPabloNow.com']);
...
export default new Schema({
  ...
  contributor: {
    // 1-9, see https://slay.fandom.com/wiki/Contributor_Rewards
    level: {
      $type: Number,
      min: 0,
      max: 9,
  ...
  // Items the user manually unpinned from the ones suggested by Slay
  unpinnedItems: [{
    _id: false,
    path: { $type: String },
    type: { $type: String },
